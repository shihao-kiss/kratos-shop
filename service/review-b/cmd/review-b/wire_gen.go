...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	reviewReplyRepo := data.NewReviewReplyRepo(dataData, logger)
	reviewReplyUsecase := biz.NewReviewReplyUsecase(reviewReplyRepo, logger)
	businessService := service.NewBusinessService(reviewReplyUsecase, logger)
