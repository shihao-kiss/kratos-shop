...
type ReviewHTTPClient interface {
	...
	ReplyReview(ctx context.Context, req *ReplyReviewRequest, opts ...http.CallOption) (rsp *ReplyReviewResp, err error)
}
...
func (c *ReviewHTTPClientImpl) ReplyReview(ctx context.Context, in *ReplyReviewRequest, opts ...http.CallOption) (*ReplyReviewResp, error) {
	var out ReplyReviewResp
	pattern := "/v1/reply_review"
	path := binding.EncodeURL(pattern, in, false)
